...
public class ComputeTax2 {
    public static void main(String[] args) {
        ...
        //choose the status
        System.out.print("0-for single filers, 1-for married jointly, 2-for married separated or widow(er), 3-for head of household:");
        ...
        switch(status) {
            case 0:
                ...
                System.out.println("Computed tax is " + (int)(tax * 100) / 100.0);
                break;
